...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.addStudent(new Student("Berdugin Oleg Igorevich", date));
        db.addStudent(new Student("Nikita Trofimov Andreevich", date));
        db.addStudent(new Student("Tolstih Stepan Sergeevich", date));
        db.addStudent(new Student("Markov Nikita Igorevich", date));
